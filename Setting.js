...
global.owner = process.env.OWNER_NUMBER  || '923465125306' ;  // ADD YOUR NUMBER WITHOUT +
...
global.sudo  =  process.env.SUDO || "923465125306" ;          // DON'T REMOVE
...
module.exports = {
  ...
  botname: process.env.BOT_NAME       || '✦-𝐉 𝐄 𝐄 𝐑 𝐘-✦',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `✦-𝐉 𝐄 𝐄 𝐑 𝐘-✦`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || '𝐌𝐃 𝐁𝐘 𝐉 𝐄 𝐄 𝐑 𝐘',      // ADD YOUR STICKER AUTHOR NAME
